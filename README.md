# 消纳通 SitePass · 智慧工地消纳与车牌核验平台
**SitePass-PlateOps** · 智慧工地消纳场资质管理、车牌核验、运单查询与场所消纳额度监控中台。

面向工程运输与渣土消纳场景，提供统一的消纳场车辆进出核验、运单实时查询、动态过期场所自动过滤与消纳方量矩阵统计大盘。

[线上访问入口](https://web.etgq.com/)
